...
/** NP Library for Matrix Computation.
 * 
 * @author Deus Jeraldy
 ...
 * @param a matrix
 * @param y matrix
 * @param batchSize scaler
 * @return loss
 */
  public static double cross_entropy(int batchSize, double[][] y, double[][] a) {
    int m = a.length;
    int n = a[0].length;
    double[][] z = new double[m][n];
  ...
  /**
   * Taking the softmax of a matrix. 
   * @param z matrix
   * @return softmax
   */
